...
class Captcha
{
    ...
    public $shadowColor = array(30, 30, 30); //array(0, 0, 0);
    ...
    /**Because this server don't support jpeg and png image,change the image type to gif */
    ...
    protected function WriteImage()
	{
		...
		elseif($this->imageFormat == 'jpeg' && function_exists('imagejpeg'))
		{
