...
{
	//允许上传附件类型
	private $allowType = array('jpg','gif','png','zip','rar','docx','doc','xls','xlsx','pdf','rmvb','rm','wmv');
        ...
        foreach($_FILES as $field => $file)
        {
            ...
            if(is_array($_FILES[$field]['name']))
            {
                ...
                foreach($keys as $key)
                {
                    ...
                    //获取扩展名
                    $fileext = IFile::getFileType1($_FILES[$field]['name'][$key]);
            ...
            else
            {
                ...
                //获取扩展名
                $fileext = IFile::getFileType1($_FILES[$field]['name']);
                if(is_array($fileext) || $fileext == null)
                {
                ...
                else
                {
	                ...
	                {
						//echo $this->dir.$fileInfo[0]['name']." FFFF";
