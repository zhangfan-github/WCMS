...
class Article
{
	...
	//展示select框栏目类型
	static function showCatType($selectName='category_type_id',$selectedValue=null,$defaultValue=array())
	{
		//取得栏目分类信息
		$catObj = new IModel('article_category_type');
		$data   = $catObj->query('','id,name,code','id','asc');
