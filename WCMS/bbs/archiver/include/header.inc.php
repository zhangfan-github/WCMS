...
<base href="<?=$boardurl?>" />
<title><?=$navtitle?> <?=$_DCACHE['settings']['bbname']?> <?=$_DCACHE['settings']['seotitle']?></title>
...
<meta name="description" content="<?=$meta_contentadd?> <?=$_DCACHE['settings']['bbname']?> <?=$_DCACHE['settings']['seodescription']?>" />
