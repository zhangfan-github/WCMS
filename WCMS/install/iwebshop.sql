...
INSERT INTO `iweb_pay_plugin` VALUES (32, '线下支付', '您可以通过现金付款或银行转帐的方式进行收款，如：中国银行  开户人：李白 帐号：4200 3234 2234 1234', '/payments/logos/pay_offline.gif', 'offline', '0.6', 1);
...
INSERT INTO `iweb_pay_plugin` VALUES (35, 'PayPal（外卡）', 'PayPal 是全球最大的在线支付平台，同时也是目前全球贸易网上支付标准。', '/payments/logos/pay_paypal.gif', 'paypal', '0.6', 0);
...
INSERT INTO `iwebshop_right` (`name`, `right`, `is_del`) VALUES
('数据库备份[展示]', 'tools@db_bak', 0),
('数据库备份[动作]', 'tools@db_act_bak', 0),
('数据库还原[展示]', 'tools@db_res', 0),
('数据库还原[动作]', 'tools@res_act', 0),
('数据库备份删除', 'tools@backup_del', 0),
('数据库备份下载', 'tools@download', 0),
('数据库备份打包下载', 'tools@download_pack', 0),
('友情链接添加和修改[展示]', 'tools@link_edit', 0),
('友情链接添加和修改[动作]', 'tools@link_edit_act', 0),
('友情链接删除', 'tools@link_del', 0),
('文章删除', 'tools@article_del', 0),
('文章添加和修改[展示]', 'tools@article_edit', 0),
('文章添加和修改[动作]', 'tools@article_edit_act', 0),
('文章分类添加和修改[展示]', 'tools@cat_edit', 0),
('文章分类添加和修改[动作]', 'tools@cat_edit_act', 0),
('文章分类删除', 'tools@cat_del', 0),
('广告位添加和修改[展示]', 'tools@ad_position_edit', 0),
('广告位添加和修改[动作]', 'tools@ad_position_edit_act', 0),
('广告位删除', 'tools@ad_position_del', 0),
('广告添加和修改[展示]', 'tools@ad_edit', 0),
('广告添加和修改[动作]', 'tools@ad_edit_act', 0),
('广告删除', 'tools@ad_del', 0),
('帮助列表', 'tools@help_list', 0),
('帮助添加和修改[展示]', 'tools@help_edit', 0),
('帮助添加和修改[动作]', 'tools@help_edit_act', 0),
('帮助删除', 'tools@help_del', 0),
('帮助分类添加和修改[展示]', 'tools@help_cat_edit', 0),
('帮助分类添加和修改[动作]', 'tools@help_cat_edit_act', 0),
('帮助分类列表', 'tools@help_cat_list', 0),
('帮助分类位置设置', 'tools@help_cat_position', 0),
('关键词添加[动作]', 'tools@keyword_add', 0),
('关键词添加[展示]', 'tools@keyword_edit', 0),
('关键词删除', 'tools@keyword_del', 0),
('关键词设置热门', 'tools@keyword_hot', 0),
('关键词排序', 'tools@keyword_order', 0),
('关键词统计商品数量', 'tools@keyword_account', 0),
('订单列表', 'order@order_list', 0),
('订单详情', 'order@order_show', 0),
('订单添加', 'order@order_add', 0),
('收款单列表', 'order@order_collection_list', 0),
('退款单列表', 'order@order_refundment_list', 0),
('发货单列表', 'order@order_delivery_list', 0),
('退货单列表', 'order@order_returns_list', 0),
('退货申请列表', 'order@refundment_list', 0),
('发货信息列表', 'order@ship_info_list', 0),
('订单删除', 'order@order_del', 0),
('收款单删除', 'order@collection_del', 0),
('退款单删除', 'order@refundment_del', 0),
('发货单删除', 'order@delivery_del', 0),
('退货单删除', 'order@returns_del', 0),
('退款申请删除', 'order@refundment_doc_del', 0),
('发货信息删除', 'order@ship_info_del', 0),
('商品模型列表', 'goods@model_list', 0),
('商品模型修改[展示]', 'goods@model_edit', 0),
('规格列表', 'goods@spec_list', 0),
('商品规格添加和修改', 'goods@spec_edit', 0),
('商品规格图库', 'goods@spec_photo', 0),
('商品添加[展示]', 'goods@goods_add', 0),
('商品修改[展示]', 'goods@goods_edit', 0),
('商品添加[动作]', 'goods@goods_save', 0),
('商品修改[动作]', 'goods@goods_update', 0),
('商品列表', 'goods@goods_list', 0),
('商品分类修改[展示]', 'goods@category_edit', 0),
('商品分类列表', 'goods@category_list', 0),
('商品模型删除', 'goods@model_del', 0),
('商品规格删除', 'goods@spec_del', 0),
('商品删除', 'goods@goods_del', 0),
('商品分类删除', 'goods@category_del', 0),
('商品规格图片删除', 'goods@spec_photo_del', 0),
('会员信息添加和修改', 'member@member_edit', 0),
('会员列表', 'member@member_list', 0),
('用户组添加和修改[展示]', 'member@group_edit', 0),
('用户组列表', 'mebmer@group_list', 0),
('会员提现申请', 'member@withdraw_list', 0),
('会员信息模板列表', 'member@tpl_list', 0),
('会员到货通知', 'member@notify_list', 0),
('评论列表', 'comment@comment_list', 0),
('讨论列表', 'comment@discussion_list', 0),
('站内消息列表', 'comment@message_list', 0),
('建议列表', 'comment@suggestion_list', 0),
('咨询列表', 'comment@refer_list', 0),
('代金券列表', 'market@ticket_list', 0),
('代金券文件列表', 'market@ticket_excel_list', 0),
('促销规则列表', 'market@pro_rule_list', 0),
('促销规则添加和修改[展示]', 'market@pro_rule_edit', 0),
('显示抢购列表', 'market@pro_speed_list', 0),
('团购列表', 'market@regiment_list', 0),
('促销规则删除', 'market@pro_rule_del', 0),
('团购删除', 'market@regiment_del', 0),
('限时抢购删除', 'market@pro_speed_del', 0),
('代金券删除', 'market@ticket_del', 0),
('代金券实体删除', 'market@ticket_more_del', 0),
('代金券实体文件删除', 'market@ticket_excel_del', 0),
('资金操作记录', 'market@account_list', 0),
('文章列表', 'tools@article_list', 0),
('商品模型修改[动作]', 'goods@model_update', 0),
('商品排序[动作]', 'goods@goods_sort', 0),
('商品回收站删除[动作]', 'goods@goods_recycle_del', 0),
('商品规格回收站删除[动作]', 'goods@spec_recycle_del', 0),
('生成缩略图[动作]', 'block@create_thumb', 1),
('建议详细页面', 'comment@suggestion_edit', 0),
('建议恢复[动作]', 'comment@suggestion_edit_act', 0),
('建议删除[动作]', 'comment@suggestion_del', 0),
('评价详情页面', 'comment@comment_edit', 0),
('评价删除[动作]', 'comment@comment_del', 0),
('讨论详情页面', 'comment@discussion_edit', 0),
('讨论删除[动作]', 'comment@discussion_del', 0),
('咨询删除[动作]', 'comment@refer_del', 0),
('咨询详情页面', 'comment@refer_edit', 0),
('咨询回复[动作]', 'comment@refer_reply', 0),
('站内信删除', 'comment@message_del', 0),
('站内信发送', 'comment@message_send', 0);